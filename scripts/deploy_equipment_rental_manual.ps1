# Manual Equipment Rental Contract Deployment Script for PowerShell
# This script manually deploys the equipment rental contract to Stellar testnet
...
Write-Host "🔧 Equipment Rental Contract Deployment" -ForegroundColor Cyan
...
$WASM_PATH = "$PROJECT_ROOT\target\wasm32v1-none\release\equipment_rental_contract.wasm"
...
$wasmFound = $false
$wasmPaths = @(
    "$PROJECT_ROOT\target\wasm32v1-none\release\equipment_rental_contract.wasm",
    "$PROJECT_ROOT\target\wasm32-unknown-unknown\release\equipment_rental_contract.wasm",
    "$CONTRACT_DIR\target\wasm32-unknown-unknown\release\equipment_rental_contract.wasm"
)
...
===========================================
Contract: equipment-rental-contract
Network: $Network
Identity: $Identity
WASM Hash: $wasmHash
...
Write-Host "  Contract: equipment-rental-contract" -ForegroundColor White
...
Write-Host "  3. Register equipment and create rental listings" -ForegroundColor White
Write-Host "  4. Test rental and maintenance workflows" -ForegroundColor White
Write-Host ""

Write-Host "✅ Equipment Rental Contract is now live on Stellar $Network!" -ForegroundColor Green