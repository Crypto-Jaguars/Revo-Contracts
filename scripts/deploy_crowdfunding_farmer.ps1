# Crowdfunding Farmer Contract Deployment - PowerShell Wrapper
# Usage: .\deploy_crowdfunding_farmer.ps1 [network] [identity]
# Example: .\deploy_crowdfunding_farmer.ps1 testnet default
...
$ZshScript = Join-Path $ScriptDir "deploy_crowdfunding_farmer.zsh"
...
Write-ColorOutput "🚀 Crowdfunding Farmer Contract Deployment" "Cyan"
