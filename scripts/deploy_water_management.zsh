...
# Water Management Contract Deployment Script
# Usage: ./deploy_water_management.zsh [network] [profile]
# Example: ./deploy_water_management.zsh testnet default
...
CONTRACT_DIR="/Users/villarley/Documents/GitHub/Revo-Contracts/ContractsRevo/water-management-contract"
WASM_PATH="${CONTRACT_DIR}/target/wasm32-unknown-unknown/release/water_management_contract.wasm"
...
setup_logging() {
    ...
    # Initialize log file
    echo "Water Management Contract Deployment Log" > "$DEPLOYMENT_LOG"
...
Water Management Contract Deployment Summary
===========================================
...
print_usage() {
    echo "Usage: ./deploy_water_management.zsh [network] [profile]"
    echo ""
    echo "Arguments:"
    ...
    echo ""
    echo "Examples:"
    echo "  ./deploy_water_management.zsh testnet                    # Deploy to testnet with default profile"
    echo "  ./deploy_water_management.zsh testnet my_profile         # Deploy to testnet with custom profile"
    echo "  ./deploy_water_management.zsh mainnet production         # Deploy to mainnet with production profile"
    echo ""
    echo "Prerequisites:"
    ...
    echo "  1. Build the water management contract"
