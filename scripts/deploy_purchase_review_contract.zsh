...
# Usage: ./deploy_purchase_review_contract.zsh [network] [profile] [source_account]
# Example: ./deploy_purchase_review_contract.zsh testnet release SCL4L2HOILNHPQ4VTFV3AFRZEYFNPLFVSWKVDD5W4ZUUKRRM3TCFC6KH
...
CONTRACT_DIR="ContractsRevo/purchase-review-contract"
WASM_PATH="$CONTRACT_DIR/target/wasm32v1-none/release/purchase_review_contract.wasm"
LOG_FILE="scripts/deploy_purchase_review_contract.log"
